package io.github.microvibe.codegen.impl;
...
import io.github.microvibe.codegen.bean.db.Column;
import io.github.microvibe.codegen.bean.db.Table;
import io.github.microvibe.dbv.DBV;
import io.github.microvibe.dbv.cfg.Configurations;
import io.github.microvibe.dbv.cfg.DatabaseCfg;
import io.github.microvibe.util.DBUtil;
import io.github.microvibe.util.StringUtil;

public class JdbcTablesReader implements io.github.microvibe.codegen.TablesReader {
	...
	public Table read(String catalogName, String schemaName, String tableName) {
		try {
			...
			// 读取数据库中的表的元数据
			List<io.github.microvibe.dbv.model.Table> tables = DBV.readTables(metaData, catalogName, schemaName,
					tableName, "TABLE");
			if (tables != null && tables.size() > 0) {
				io.github.microvibe.dbv.model.Table tab = tables.get(0);
				...
				List<io.github.microvibe.dbv.model.Column> columnList = tab.getColumnList();
				for (io.github.microvibe.dbv.model.Column col : columnList) {
